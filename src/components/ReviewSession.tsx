...
import type { VocabCard as VocabCardType, GrammarCard as GrammarCardType, CardType, PerfektCard as PerfektCardType, PluralCard as PluralCardType, ConjugationCard as ConjugationCardType, SentenceCard as SentenceCardType, WelcherCard as WelcherCardType } from '../data/types';
...
type Card = VocabCardType | GrammarCardType | PerfektCardType | PluralCardType | ConjugationCardType | SentenceCardType | WelcherCardType;
